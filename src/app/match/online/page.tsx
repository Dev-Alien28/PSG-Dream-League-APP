...
export default function MatchOnlinePage() {
  ...
  return (
    <>
      <style>{`
        ...
        .event-min { font-size: 11px; color: var(--text-muted); min-width: 28px; }
      ...
      <div className="match-page">
        <div className="match-header">
          <div className="match-header-left">
            <button className="match-back-btn" onClick={() => router.push('/match')}>
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M15 18l-6-6 6-6"/>
              </svg>
            </button>
            <div className="match-title">Match en ligne</div>
          </div>
        ...
        {pageState === 'result' && result && (
          <div className="result-screen">
            ...
            <div className="result-actions">
              ...
              <button className="btn btn-ghost" style={{ width: '100%', padding: '12px', borderRadius: 12 }} onClick={() => router.push('/match')}>
                Retour au hub
              </button>
            </div>
          </div>
